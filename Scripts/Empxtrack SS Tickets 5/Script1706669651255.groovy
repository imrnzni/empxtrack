...
WebUI.waitForElementVisible(findTestObject('Empxtrack_SSTickets/Page_Home page/input_OR__selectedSearchOnTicketId'), 0)

WebUI.setText(findTestObject('Empxtrack_SSTickets/Page_Home page/input_OR__selectedSearchOnTicketId'), '1003056')

WebUI.click(findTestObject('Empxtrack_SSTickets/Page_Home page/a_Go'))

WebUI.waitForElementVisible(findTestObject('Empxtrack_SSTickets/Page_Home page/td_1003056'), 0)

WebUI.verifyElementPresent(findTestObject('Empxtrack_SSTickets/Page_Home page/td_1003056'), 0)
