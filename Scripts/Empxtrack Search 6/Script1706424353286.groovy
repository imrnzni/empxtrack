...
WebUI.setText(findTestObject('Empxtrack_Search/Page_Home page/input_Loading_moduleName'), '@abu')

WebUI.verifyElementPresent(findTestObject('Empxtrack_Search/Page_Home page/div_Oops, nothing found abu'), 0)
