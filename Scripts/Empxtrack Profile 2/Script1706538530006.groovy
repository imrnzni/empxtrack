...
WebUI.waitForElementVisible(findTestObject('Empxtrack_Profile/Page_Home page/a_View in full page'), 0)

WebUI.click(findTestObject('Empxtrack_Profile/Page_Home page/a_View in full page'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementVisible(findTestObject('Empxtrack_Profile/Page_Home page/div_Profile_Details'), 0)

WebUI.verifyElementPresent(findTestObject('Empxtrack_Profile/Page_Home page/div_Profile_Details'), 0)
