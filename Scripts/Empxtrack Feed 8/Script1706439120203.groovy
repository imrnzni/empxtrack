...
WebUI.click(findTestObject('Empxtrack_Feed/Page_Home page/a_See All'))

WebUI.verifyElementPresent(findTestObject('Empxtrack_Feed/Page_Home page/div_Social feedHelp'), 0)
