...
WebUI.click(findTestObject('Empxtrack_Profile/Page_Home page/i_Help_fas fa-eye'))

WebUI.verifyElementPresent(findTestObject('Empxtrack_Profile/Page_Home page/span_View all changes to my data'), 0)
