...
WebUI.click(findTestObject('Empxtrack_Feed/Page_Home page/i_Say hello to emp 10 on joining  as Default_fas fa-caret-down'))

WebUI.verifyElementPresent(findTestObject('Empxtrack_Feed/Page_Home page/div_emp 04hello'), 0)
