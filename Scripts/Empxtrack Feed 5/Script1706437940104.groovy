...
WebUI.click(findTestObject('Empxtrack_Feed/Page_Home page/button_OK'))

WebUI.verifyElementPresent(findTestObject('Empxtrack_Feed/Page_Home page/div_Please enter the comment'), 0)
