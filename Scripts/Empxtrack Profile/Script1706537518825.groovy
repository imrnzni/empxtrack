...
WebUI.waitForElementVisible(findTestObject('Empxtrack_Profile/Page_Home page/div_emp 04Help'), 0)

WebUI.verifyElementPresent(findTestObject('Empxtrack_Profile/Page_Home page/div_emp 04Help'), 0)
