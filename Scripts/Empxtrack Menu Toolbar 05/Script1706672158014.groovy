...
WebUI.waitForElementVisible(findTestObject('Empctrack_Menu/Page_Home page/a_Open'), 0)

WebUI.click(findTestObject('Empctrack_Menu/Page_Home page/a_Open'))

WebUI.waitForElementVisible(findTestObject('Empctrack_Menu/Page_Home page/p_How do you like the new coffee vendor'), 0)

WebUI.click(findTestObject('Empctrack_Menu/Page_Home page/input_Did not try_DynamicRadioBox'))
