...
WebUI.setEncryptedText(findTestObject('Empxtrack_Profile_Icon/Page_Home page/input_Confirm password_cpassword'), newPassword)

WebUI.click(findTestObject('Empxtrack_Profile_Icon/Page_Home page/a_Update'))

WebUI.verifyElementPresent(findTestObject('Empxtrack_Profile_Icon/Page_Home page/div_Password updated successfully'), 0)
