...
WebUI.waitForElementVisible(findTestObject('Empxtrack_DashAttendance/Page_Home page/a_Start'), 0)

WebUI.click(findTestObject('Object Repository/Empxtrack_DashAttendance/Page_Home page/a_Start'))
