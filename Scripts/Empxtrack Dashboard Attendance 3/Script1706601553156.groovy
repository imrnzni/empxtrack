...
WebUI.waitForElementVisible(findTestObject('Empxtrack_DashAttendance/Page_Home page/a_Resume work'), 0)

WebUI.click(findTestObject('Empxtrack_DashAttendance/Page_Home page/a_Resume work'))
