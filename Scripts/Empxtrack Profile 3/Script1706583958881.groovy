...
WebUI.setText(findTestObject('Empxtrack_Profile/Page_Home page/input_Your Hobbies  Interests_hobbies0 (1)'), 'Hobby01')

WebUI.click(findTestObject('Empxtrack_Profile/Page_Home page/i_Your Hobbies  Interests_fa fa-save (1)'))

WebUI.verifyElementPresent(findTestObject('Empxtrack_Profile/Page_Home page/div_Record has been added successfully (1)'), 
    0)
