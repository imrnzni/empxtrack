...
WebUI.click(findTestObject('Empxtrack_Feed/Page_Home page/a_Whats on your mind'))

WebUI.verifyElementPresent(findTestObject('Empxtrack_Feed/Page_Home page/div_Only employee and HR Manager can add a feed'), 
    0)
