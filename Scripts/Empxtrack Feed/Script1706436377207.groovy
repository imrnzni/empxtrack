...
WebUI.setText(findTestObject('Object Repository/Empxtrack_Feed/Page_Home page/input_Say hello to emp 10 on joining  as De_b8626a'), 
    'hello')

WebUI.click(findTestObject('Object Repository/Empxtrack_Feed/Page_Home page/i_Say hello to emp 10 on joining  as Defaul_35f1c0'))
