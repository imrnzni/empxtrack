...
WebUI.setText(findTestObject('Empxtrack_Search/Page_Home page/input_Loading_moduleName'), 'abcde')

WebUI.verifyElementPresent(findTestObject('Empxtrack_Search/Page_Home page/div_Oops, nothing found abcde'), 0)
