...
WebUI.waitForElementVisible(findTestObject('Empctrack_Menu/Page_Home page/img_calendar'), 0)

WebUI.click(findTestObject('Empctrack_Menu/Page_Home page/img_calendar'))

WebUI.verifyElementPresent(findTestObject('Empctrack_Menu/Page_Home page/h3_Time based activities'), 0)
