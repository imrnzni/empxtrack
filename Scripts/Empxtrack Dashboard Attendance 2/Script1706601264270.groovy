...
WebUI.waitForElementVisible(findTestObject('Object Repository/Empxtrack_DashAttendance/Page_Home page/a_Add break'), 0)

WebUI.click(findTestObject('Object Repository/Empxtrack_DashAttendance/Page_Home page/a_Add break'))
