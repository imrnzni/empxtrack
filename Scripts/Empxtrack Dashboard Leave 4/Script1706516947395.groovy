...
WebUI.click(findTestObject('Empxtrack_DashLeave/Page_Home page/input_End on first-half of 3101_dataObject.secondHalf'))

WebUI.verifyElementPresent(findTestObject('Empxtrack_DashLeave/Page_Home page/div_You cannot select both partial days option on the same day of leave'), 
    0)
